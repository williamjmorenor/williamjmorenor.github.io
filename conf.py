...
BLOG_AUTHOR = "William Moreno Reyes"  # (translatable)
BLOG_TITLE = "William Moreno Github's page"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://williamjmorenor.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://williamjmorenor.github.io/"
BLOG_EMAIL = "williamjmorenor@gmail.com"
BLOG_DESCRIPTION = "This is my python based blog"  # (translatable)
